  ...
  return (
    <div className="page-shell">
      <section className="surface px-6 py-8 sm:px-8">
        ...
        <h1 className="font-display text-4xl font-bold text-[var(--text)] sm:text-5xl">Product, platform, and immersive engineering experience.</h1>
          ...
          <article key={exp.id} className="surface px-6 py-7">
            <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
              <div>
                ...
                <h2 className="mt-2 font-display text-3xl font-bold text-[var(--text)]">{exp.company}</h2>
